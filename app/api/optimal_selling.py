...
# Assuming app is running from the root 'saveetha' folder
...
class AgriLogic:
    ...
    @staticmethod
    def get_calendar_data_dict():
        """
        Loads data and maps day number to the full data object for quick HTML lookup.
        Returns: {day_int: item_dict}
        """
        data = AgriLogic.load_data()
